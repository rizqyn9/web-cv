...
let res =document.body.appendChild(renderer.domElement);
...
function Mat(){
  var material = new THREE.MeshPhongMaterial({
    color      : new THREE.Color("black"),  //Diffuse color of the material
    emissive   : new THREE.Color("#6FFFE9"), //Emissive(light) color of the material, essentially a solid color unaffected by other lighting. Default is black.
